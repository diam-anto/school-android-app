...
public class Section3 extends AppCompatActivity implements View.OnTouchListener, ViewTreeObserver.OnScrollChangedListener{
    ScrollView scrollView;
    WebView WvSect;
    Button BtNextStep;


    public String fileName = "section-3.html";
    ...
    public void onScrollChanged(){
        ...
        if(bottomDetector == 0 ){
            Intent intent = new Intent(Section3.this, StartTest3.class);
